...
namespace c___Api_Example.Controllers
{
   ...
   public class CaixaController : ControllerBase
   {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<int>> UpdateCaixa(int id, [FromBody] CaixaPutDto caixaPutDto)
        {
            int updatedCaixaId = await _caixaRepositorio.UpdateCaixa(id, caixaPutDto);
            return Ok(updatedCaixaId);  
        }
